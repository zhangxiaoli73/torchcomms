...
onecclResult_t DefaultXcclApi::send(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclSend(const_cast<void*>(sendbuff), count, datatype, peer, comm, stream);
}
...
onecclResult_t DefaultXcclApi::broadcast(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclBroadcast(const_cast<void*>(sendbuff), recvbuff, count, datatype, root, comm, stream);
}
...
onecclResult_t DefaultXcclApi::allReduce(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclAllReduce(const_cast<void*>(sendbuff), recvbuff, count, datatype, op, comm, stream);
}
...
onecclResult_t DefaultXcclApi::reduce(
    ...
    xpuStream_t stream) {
  return onecclReduce(
      const_cast<void*>(sendbuff), recvbuff, count, datatype, op, root, comm, stream);
}
...
onecclResult_t DefaultXcclApi::allGather(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclAllGather(const_cast<void*>(sendbuff), recvbuff, sendcount, datatype, comm, stream);
}
...
onecclResult_t DefaultXcclApi::reduceScatter(
  ...
  return onecclReduceScatter(
      const_cast<void*>(sendbuff), recvbuff, recvcount, datatype, op, comm, stream);
}
...
onecclResult_t DefaultXcclApi::allToAll(
    ...
    onecclComm_t comm,
    xpuStream_t stream) {
  return onecclAllToAll(const_cast<void*>(sendbuff), recvbuff, count, datatype, comm, stream);
}
...
onecclResult_t DefaultXcclApi::commUserRank(const onecclComm_t comm, int* myRank) {
...
onecclResult_t DefaultXcclApi::redOpDestroy(onecclRedOp_t op, onecclComm_t comm) {
